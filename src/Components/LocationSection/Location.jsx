  ...
  return (
    <section className="relative mb-32">
      ...
      <div className="absolute wrap -bottom-[55px] left-0 right-0 w-full px-6 md:px-12 z-[999]">
        <div className="block rounded-lg  p-5 px-10 bg-accentA bg-opacity-80  shadow-lg  backdrop-blur-[10px] border border-gray-300/10">
          <div className="flex flex-wrap">
            ...
            <div className=" w-full md:w-6/12 flex items-center">
              ...
              <div className="ml-6">
                ...
                <p className="text-sm text-textT/70">{apartmentLocation.address}</p>
              </div>
            </div>
          </div>
        </div>
